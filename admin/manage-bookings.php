...
if (strlen($_SESSION['alogin']) == 0) {
	...
	// mengambi informasi data dari tabel
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														<td><?php
															if ($result->Status == 0) {
																echo htmlentities('Belum Dilakukan Tindakan');
															} else if ($result->Status == 1) {
																echo htmlentities('Konfirmasi');
															} else {
																echo htmlentities('Batalkan');
															}
															?></td>
														<td><?php echo htmlentities($result->PostingDate); ?></td>
														<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Apakah anda yakin ingin konfirmasi')"> Konfirmasi</a> /


															<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Apakah anda yakin ingin membatalkan')"> Batal</a>
														</td>
