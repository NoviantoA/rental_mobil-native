...
?>
	...
	<head>
		...
		<title>Admin Panel | Admin Update Gambar</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Gambar Mobil </h2>

							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Detail Gambar Mobil </div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label class="col-sm-4 control-label">Upload Gambar Baru<span style="color:red">*</span></label>
													<div class="col-sm-8">
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														...
														<button class="btn btn-primary" style="width: 100px; background-color:#067106; font-size:14px;" name="update" type="submit">Update</button>
													</div>
												</div>
