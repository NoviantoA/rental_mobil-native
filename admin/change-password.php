...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($query->rowCount() > 0) {
			...
			$error = "Kata sandi Anda saat ini tidak valid.";
		}
	}
?>
		...
		<script type="text/javascript">
			function valid() {
				if (document.chngpwd.newpassword.value != document.chngpwd.confirmpassword.value) {
					alert("Kata Sandi baru dan Konfirmasi Kata Sandi tidak cocok. Silahkan coba lagi  !!");
											...
											<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();">
												...
												<div class="form-group">
													<div class="col-sm-8 col-sm-offset-4">
														...
														<button class="btn btn-primary" style="width: 100px; background-color:#067106; font-size:14px;" name="submit" type="submit">Update</button>
													</div>
												</div>
