...
?>
	...
	<head>
		...
		<title>Admin Panel |Admin Manage Mobil </title>
	...
	<body>
		<!-- minclude tampilan header dan leftbar -->
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Manage Mobil</h2>
												...
												foreach ($results as $result) {				?>
													...
													<tr>
														...
														<td><a href="edit-vehicle.php?id=<?php echo $result->id; ?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
															<a href="manage-vehicles.php?del=<?php echo $result->id; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><i class="fa fa-close"></i></a>
														</td>
													</tr>
											<?php $cnt = $cnt + 1;
												}
