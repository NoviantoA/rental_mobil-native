											...
											<div class="panel panel-default">
												<div class="panel-body bk-primary text-light">
													<div class="stat-panel text-center">
														...
														<!-- menmpilakan data dari tabel user  -->
														<?php
														...
														<div class="stat-panel-title text-uppercase">User yang Terdaftar</div>
													</div>
												</div>
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-success text-light">
													<div class="stat-panel text-center">
														<!-- menampilkan data dari tabel vehicle -->
														<?php
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-info text-light">
													<div class="stat-panel text-center">
														<!-- menampilkan data dari tabel booking -->
														<?php
										...
										<div class="col-md-3">
											<div class="panel panel-default">
												<div class="panel-body bk-warning text-light">
													<div class="stat-panel text-center">
														<!-- menampilkan data dari tabel merek -->
														<?php
