...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		// deklarasi variabel dengan value nama kolom pada tabel vehichle
		...
		$id = intval($_GET['id']);
		// kode sql untuk melakukan updae data pada tabel
		...
		// menampung variabel dengan fungsi bindparam
...
?>
	...
	<head>
		...
		<title>Admin Panel | Admin Edit Mobil</title>
	...
	<body>
		<!-- include tampilan leftbar dan header -->
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<!-- mengambil informasi mobil berdasarkan id -->
											<?php
											$id = intval($_GET['id']);
												...
												foreach ($results as $result) {	?>
													...
													<form method="post" class="form-horizontal" enctype="multipart/form-data">
														...
														<div class="form-group">
															...
															<label class="col-sm-2 control-label">Bahan Bakar<span style="color:red"> *</span></label>
															<div class="col-sm-4">
														...
														<div class="form-group">
															...
															<label class="col-sm-2 control-label">Tempat Duduk<span style="color:red"> *</span></label>
															<div class="col-sm-4">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">Perlengkapan</div>
										<div class="panel-body">
												...
												<div class="col-sm-3">
													<?php if ($result->PowerDoorLocks == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox2"> Kunci Pintu Elektronik </label>
														</div>
													<?php } else { ?>
												...
												<div class="col-sm-3">
													<?php if ($result->AntiLockBrakingSystem == 1) { ?>
														<div class="checkbox checkbox-inline">
															...
															<label for="inlineCheckbox3"> Sistem Pengereman AntiLock </label>
														</div>
													<?php } else { ?>
														<div class="checkbox checkbox-inline">
														...
														<?php } else { ?>
															...
															<div class="col-sm-3">
																...
																?>
																	<div class="checkbox checkbox-inline">
																		...
																		<label for="inlineCheckbox2">Airbag Pengemudi</label>
																	</div>
																<?php } else { ?>
																	<div class="checkbox checkbox-inline">
																	...
																	<div class="col-sm-3">
																		...
																		?>
																			<div class="checkbox checkbox-inline">
																				...
																				<label for="inlineCheckbox3"> Airbag Penumpang </label>
																			</div>
																		<?php } else { ?>
																			<div class="checkbox checkbox-inline">
																		...
																		<div class="col-sm-3">
																			...
																			?>
																				<div class="checkbox checkbox-inline">
																					...
																					<label for="inlineCheckbox3"> Sensor Kerusakan </label>
																				</div>
																			<?php } else { ?>
																				<div class="checkbox checkbox-inline">
															...
															<div class="form-group">
																<div class="col-sm-8 col-sm-offset-2">
																	...
																	<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%; width: 100px; background-color:#067106; font-size:14px;">Simpan</button>
																</div>
															</div>
